...
class Model():
    ...
    def create_model(self, x_shape, num_classes):
        ...
        fc1 = layers.Dense(opts.dense_layer_size, activation='relu', name='dense1')(flat)
        fc2 = layers.Dense(opts.dense_layer_size, activation='relu', name='dense2')(fc1)
        # 3) Add a classification output layer
        classifier = layers.Dense(num_classes, activation='softmax', name='classifier')(fc2)
